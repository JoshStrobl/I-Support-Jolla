...
var isupportjolla;(function(a){(function(a){a.CreateError=function(a,e,c){var b=document.createElement("div");b.setAttribute("data-isupportjolla-error",a);b.textContent=e;"undefined"!==typeof c&&c.appendChild(b);return b}})(a.errors||(a.errors={}))})(isupportjolla||(isupportjolla={}));var twttr;(function(a){a.GetDirection=function(){return document.body.getAttribute("dir")};a.GetLanguage=function(){return document.querySelector("html").getAttribute("lang")}})(isupportjolla||(isupportjolla={}));
...
lang:a.GetLanguage(),tweetLimit:10}))};b.CreateSailfishExperienceTimeline=function(){var b=document.querySelector('div[data-isupportjolla-component="sailfish-experience-timeline"]');null!==b&&(a.twitter.IsTwitterBlocked?a.errors.CreateError("twttr",a.twitter.IsTwitterBlockedMessage,b):twttr.widgets.createGridFromCollection("678194475089444864",b,{height:400,border:"#ffffff",chrome:"noheader,nofooter,noborders,transparent",lang:a.GetLanguage(),tweetLimit:5,limit:5}))};b.GenerateForm=function(){a.twitter.Form=
