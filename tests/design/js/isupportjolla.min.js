...
c.Error),a.PrimaryContent.appendChild(d)}.bind(this,e);a.net.Request("http://isupportjolla.com/letters-api","POST",{Action:"get",LetterId:c},b)};d.HideLetter=function(){var c=a.PrimaryContent.querySelector("div[data-isupportjolla-error]");null!==c?a.PrimaryContent.removeChild(c):(c=a.letters.PublishedLetter.querySelector('div[data-isupportjolla-component="letter-metadata"]'),a.letters.PublishedLetter.removeChild(c),a.letters.PublishedLetterContent.innerHTML="",a.PrimaryContent.querySelector('div[data-isupportjolla-component="letters-list-items"]').removeAttribute("hide"),
