...
document.querySelector('div[data-isupportjolla-component="tweet-form"]');a.twitter.FormInput=document.createElement("textarea");a.twitter.FormInput.setAttribute("placeholder",a.Config.PositiveInputText);a.twitter.FormInput.setAttribute("maxlength","140");a.twitter.FormInput.setAttribute("tabindex","1");a.twitter.FormButton=document.createElement("a");a.twitter.FormButton.setAttribute("target","_blank");a.twitter.FormButton.textContent="Tweet";a.twitter.FormButton.setAttribute("tabindex","2");a.twitter.Form.appendChild(a.twitter.FormInput);
a.twitter.Form.appendChild(a.twitter.FormButton)};b.GenerateSailfishPhotoGrid=function(){var b=document.querySelector('div[data-isupportjolla-component="fullwidth-content"][data-isupportjolla-page="sailfish"]');600<a.GetPageWidth()?a.twitter.CreateSailfishExperienceTimeline():a.twitter.ActivateLoadPrompt(b,a.twitter.CreateSailfishExperienceTimeline)};b.GenerateTimeline=function(){600<a.GetPageWidth()?a.twitter.CreateSailorFeedTimeline():a.twitter.ActivateLoadPrompt(a.Sidepane,a.twitter.CreateSailorFeedTimeline)};
b.TrackInput=function(){if(-1!==a.twitter.FormInput.value.indexOf("#ISupportJolla")){var b=encodeURIComponent(a.twitter.FormInput.value),b="https://twitter.com/share?related=JoshStrobl"+encodeURIComponent(",")+"JollaHQ&text="+b;a.twitter.FormButton.setAttribute("href",b)}else a.twitter.FormButton.removeAttribute("href")}})(a.twitter||(a.twitter={}))})(isupportjolla||(isupportjolla={}));
